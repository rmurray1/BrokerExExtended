{ **************************************************************
  ...
  Current Release: Version 1.1 Patch 73
  *************************************************************** }
...
uses
  ...
  {VA}
  VWHash, MFunStr, TrpcbH, SgnonCnf, XWBut1, frmSignonMessageH, XWBRich20,
...
uses
  RpcSloginH, VCEditH, fRPCBErrMsg, RpcConf1, XlfSid;
